...
class FieldTestMapstructAndServiceClassEntityResourceIT {
    ...
    public void initTest() {
        fieldTestMapstructAndServiceClassEntityRepository.deleteAll().block();
    ...
    void getAllFieldTestMapstructAndServiceClassEntities() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(fieldTestMapstructAndServiceClassEntity.getId()))
            .jsonPath("$.[*].stringEva")
    ...
    void getFieldTestMapstructAndServiceClassEntity() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(fieldTestMapstructAndServiceClassEntity.getId()))
            .jsonPath("$.stringEva")
    ...
    void putNonExistingFieldTestMapstructAndServiceClassEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestMapstructAndServiceClassEntityRepository.findAll().collectList().block().size();
        fieldTestMapstructAndServiceClassEntity.setId(UUID.randomUUID().toString());
