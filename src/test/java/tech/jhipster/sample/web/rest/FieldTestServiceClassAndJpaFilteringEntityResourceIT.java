...
class FieldTestServiceClassAndJpaFilteringEntityResourceIT {
    ...
    public void initTest() {
        fieldTestServiceClassAndJpaFilteringEntityRepository.deleteAll().block();
    ...
    void getAllFieldTestServiceClassAndJpaFilteringEntities() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(fieldTestServiceClassAndJpaFilteringEntity.getId()))
            .jsonPath("$.[*].stringBob")
    ...
    void getFieldTestServiceClassAndJpaFilteringEntity() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(fieldTestServiceClassAndJpaFilteringEntity.getId()))
            .jsonPath("$.stringBob")
    ...
    void putNonExistingFieldTestServiceClassAndJpaFilteringEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestServiceClassAndJpaFilteringEntityRepository.findAll().collectList().block().size();
        fieldTestServiceClassAndJpaFilteringEntity.setId(UUID.randomUUID().toString());
