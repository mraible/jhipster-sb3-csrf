...
class FieldTestServiceImplEntityResourceIT {
    ...
    public void initTest() {
        fieldTestServiceImplEntityRepository.deleteAll().block();
    ...
    void getAllFieldTestServiceImplEntities() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(fieldTestServiceImplEntity.getId()))
            .jsonPath("$.[*].stringMika")
    ...
    void getFieldTestServiceImplEntity() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(fieldTestServiceImplEntity.getId()))
            .jsonPath("$.stringMika")
    ...
    void putNonExistingFieldTestServiceImplEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestServiceImplEntityRepository.findAll().collectList().block().size();
        fieldTestServiceImplEntity.setId(UUID.randomUUID().toString());
