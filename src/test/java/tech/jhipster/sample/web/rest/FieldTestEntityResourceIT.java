...
class FieldTestEntityResourceIT {
    ...
    private static final String DEFAULT_NUMBER_PATTERN_TOM = "1603";
    private static final String UPDATED_NUMBER_PATTERN_TOM = "9";

    private static final String DEFAULT_NUMBER_PATTERN_REQUIRED_TOM = "526642";
    private static final String UPDATED_NUMBER_PATTERN_REQUIRED_TOM = "7491";
    ...
    public void initTest() {
        fieldTestEntityRepository.deleteAll().block();
    ...
    void getAllFieldTestEntities() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(fieldTestEntity.getId()))
            .jsonPath("$.[*].stringTom")
    ...
    void getFieldTestEntity() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(fieldTestEntity.getId()))
            .jsonPath("$.stringTom")
    ...
    void putNonExistingFieldTestEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestEntityRepository.findAll().collectList().block().size();
        fieldTestEntity.setId(UUID.randomUUID().toString());
