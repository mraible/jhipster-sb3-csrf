...
class FieldTestInfiniteScrollEntityResourceIT {
    ...
    public void initTest() {
        fieldTestInfiniteScrollEntityRepository.deleteAll().block();
    ...
    void getAllFieldTestInfiniteScrollEntities() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.[*].id")
            .value(hasItem(fieldTestInfiniteScrollEntity.getId()))
            .jsonPath("$.[*].stringHugo")
    ...
    void getFieldTestInfiniteScrollEntity() {
        ...
        webTestClient
            ...
            .expectBody()
            .jsonPath("$.id")
            .value(is(fieldTestInfiniteScrollEntity.getId()))
            .jsonPath("$.stringHugo")
    ...
    void putNonExistingFieldTestInfiniteScrollEntity() throws Exception {
        int databaseSizeBeforeUpdate = fieldTestInfiniteScrollEntityRepository.findAll().collectList().block().size();
        fieldTestInfiniteScrollEntity.setId(UUID.randomUUID().toString());
