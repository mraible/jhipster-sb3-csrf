...
public class FieldTestEntityResource {
    ...
    public Mono<ResponseEntity<FieldTestEntity>> getFieldTestEntity(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteFieldTestEntity(@PathVariable String id) {
