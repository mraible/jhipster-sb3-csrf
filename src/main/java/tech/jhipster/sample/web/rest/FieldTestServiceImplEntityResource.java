...
public class FieldTestServiceImplEntityResource {
    ...
    public Mono<ResponseEntity<FieldTestServiceImplEntity>> getFieldTestServiceImplEntity(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteFieldTestServiceImplEntity(@PathVariable String id) {
