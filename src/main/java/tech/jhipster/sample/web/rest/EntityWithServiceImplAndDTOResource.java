...
public class EntityWithServiceImplAndDTOResource {
    ...
    public Mono<ResponseEntity<EntityWithServiceImplAndDTODTO>> getEntityWithServiceImplAndDTO(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteEntityWithServiceImplAndDTO(@PathVariable String id) {
