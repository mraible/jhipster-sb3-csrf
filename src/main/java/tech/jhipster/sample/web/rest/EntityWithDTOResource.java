...
public class EntityWithDTOResource {
    ...
    public Mono<ResponseEntity<EntityWithDTODTO>> getEntityWithDTO(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteEntityWithDTO(@PathVariable String id) {
