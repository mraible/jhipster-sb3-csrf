...
} from '../service/entity-with-service-impl-and-pagination.service';
...
export class EntityWithServiceImplAndPaginationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEntityWithServiceImplAndPagination): string =>
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.entityWithServiceImplAndPaginations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(
    data: IEntityWithServiceImplAndPagination[] | null
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.entityWithServiceImplAndPaginationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
