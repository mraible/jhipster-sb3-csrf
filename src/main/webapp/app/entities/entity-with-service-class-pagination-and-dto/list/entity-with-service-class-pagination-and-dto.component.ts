...
} from '../service/entity-with-service-class-pagination-and-dto.service';
...
export class EntityWithServiceClassPaginationAndDTOComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEntityWithServiceClassPaginationAndDTO): string =>
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.entityWithServiceClassPaginationAndDTOS = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(
    data: IEntityWithServiceClassPaginationAndDTO[] | null
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.entityWithServiceClassPaginationAndDTOService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
