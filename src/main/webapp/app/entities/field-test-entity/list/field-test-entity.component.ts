...
import { EntityArrayResponseType, FieldTestEntityService } from '../service/field-test-entity.service';
...
export class FieldTestEntityComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFieldTestEntity): string => this.fieldTestEntityService.getFieldTestEntityIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.fieldTestEntities = this.refineData(dataFromBody);
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: IFieldTestEntity[] | null): IFieldTestEntity[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.fieldTestEntityService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
