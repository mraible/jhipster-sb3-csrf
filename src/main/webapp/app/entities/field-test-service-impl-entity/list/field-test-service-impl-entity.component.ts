...
import { EntityArrayResponseType, FieldTestServiceImplEntityService } from '../service/field-test-service-impl-entity.service';
...
export class FieldTestServiceImplEntityComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFieldTestServiceImplEntity): string =>
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.fieldTestServiceImplEntities = this.refineData(dataFromBody);
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: IFieldTestServiceImplEntity[] | null): IFieldTestServiceImplEntity[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.fieldTestServiceImplEntityService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
