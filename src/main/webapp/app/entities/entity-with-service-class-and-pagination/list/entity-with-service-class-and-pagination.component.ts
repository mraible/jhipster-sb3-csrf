...
} from '../service/entity-with-service-class-and-pagination.service';
...
export class EntityWithServiceClassAndPaginationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEntityWithServiceClassAndPagination): string =>
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.entityWithServiceClassAndPaginations = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(
    data: IEntityWithServiceClassAndPagination[] | null
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.entityWithServiceClassAndPaginationService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
