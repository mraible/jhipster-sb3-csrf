...
import { EntityArrayResponseType, EntityWithServiceImplAndDTOService } from '../service/entity-with-service-impl-and-dto.service';
...
export class EntityWithServiceImplAndDTOComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEntityWithServiceImplAndDTO): string =>
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.entityWithServiceImplAndDTOS = this.refineData(dataFromBody);
  }
  ...
  protected fillComponentAttributesFromResponseBody(data: IEntityWithServiceImplAndDTO[] | null): IEntityWithServiceImplAndDTO[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.entityWithServiceImplAndDTOService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
